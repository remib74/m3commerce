...
<input type="submit" value="deconnection"/>
       ...
       <form method="POST" action="creer_rubrique.php">
        ...
        <?php $sqlprod="SELECT * FROM m3_prod ORDER BY id";
                ...
                $rowid=$row['id'];
                $rowRub=$row['rubrique'];
                echo "<div class='box-content2'><form action='delprod.php' method='POST'><div style='float:left;height:40px;margin:10px;'><input type='submit' name='envoyer'  value='$rowid'></div><input type='hidden' name='$rowid' value='$rowid'></form>" .$row['title'].' '.$row['rubrique']."&nbsp;&nbsp;&nbsp;"."<img src='../public/img/prod/$rowRub/$rowid.jpg' width=30px height=30px>".
                "</div>";       
